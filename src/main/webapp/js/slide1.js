...
var sliderApp=angular.module('sliderApp',['ngAnimate','dc.endlessScroll']);
...
sliderApp.controller('SliderController', function($scope, $location, $http, $templateCache, $timeout, PostLoader) {
